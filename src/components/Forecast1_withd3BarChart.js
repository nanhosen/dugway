//this uses d3 to make a bar chart with dummy data for nothing in particular. Found that if added refs to first two date colums could figure out distance between columns and then from there would be able to set spacing between bars. Not implemented. 
